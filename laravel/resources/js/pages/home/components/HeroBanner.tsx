    ...
    return (
        <div className="bg-surface relative h-64 w-full overflow-hidden rounded-lg sm:h-80 lg:h-96 xl:h-[500px]">
                            ...
                            <div className="mx-auto max-w-4xl">
                                ...
                                <Link href={banner?.ctaLink} className="block">
                                    <Button
                                        variant="default"
                                        size="lg"
                                        className="cursor-pointer bg-background px-8 py-3 font-semibold text-primary hover:bg-secondary/90"
                                    >
                                        {banner?.ctaText}
                                    </Button>
                                </Link>
            ...
            <button
                ...
                className="absolute bottom-0 left-4 flex h-10 w-10 -translate-y-1/2 transform items-center justify-center rounded-full bg-white/20 text-white backdrop-blur-sm transition-all duration-200 hover:bg-white/30 md:top-1/2"
            ...
            <button
                onClick={goToNext}
                className="absolute right-4 bottom-0 flex h-10 w-10 -translate-y-1/2 transform items-center justify-center rounded-full bg-white/20 text-white backdrop-blur-sm transition-all duration-200 hover:bg-white/30 md:top-1/2"
