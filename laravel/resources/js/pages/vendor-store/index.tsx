    ...
    const reviews = [
        {
            ...
            date: '2 days ago',
            comment:
                'Excellent service and fast shipping! The product arrived exactly as described and the customer support was very helpful when I had questions.',
            isVerified: true,
            helpfulCount: 12,
        ...
        },
        {
            ...
            date: '1 week ago',
            comment:
                'Good quality products and reasonable prices. The MacBook I ordered works perfectly. Only minor issue was the packaging could be better.',
            isVerified: true,
            helpfulCount: 8,
        ...
        },
        {
            ...
            date: '2 weeks ago',
            comment:
                "Amazing store! I\'ve been buying from TechStore Pro for over a year now and they never disappoint. Great selection and competitive prices.",
            isVerified: true,
            helpfulCount: 15,
            vendorResponse: {
                date: '2 weeks ago',
    ...
    return (
        <GuestLayout>
            ...
            <main className="flex-1">
                ...
                <VendorHeader vendor={vendor} onFollow={handleFollow} onContact={handleContact} isFollowing={isFollowing} />
