...
type ProductHighlightTypes = 'recently_viewed' | 'best_deals' | 'weekly_deals' | 'new_arrivals' | 'most_popular';
...
const useHighlight = <T extends HighlightItem = HighlightItem>(type: ProductHighlightTypes): T[] => {
