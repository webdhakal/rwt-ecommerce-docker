    ...
    'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
    {
        variants: {
            variant: {
                ...
                close: 'absolute top-0 shadow-sm hover:bg-close-hover bg-close group-hover:h-6 group-hover:items-end group-hover:pb-1 [&_svg]:size-3 text-white p-2',
            },
            size: {
...
const Button = React.forwardRef<HTMLButtonElement | HTMLAnchorElement, ButtonProps>(
    ({ className, variant, size, asChild = false, href, method, toolTip, onSheet, ...props }, ref) => {
        ...
        //@ts-expect-error ( dont think very important )
