...
import { CartItemRequest, getCartItems, removeCartItem, storeCart, updateCartItem } from '../endpoints/shopping-cart.api';
...
const queryClient = useQueryClient();
  ...
  >({
    mutationFn: ({ variant, quantity, cartId }) => 
      storeCart({ variant, quantity }, cartId), // Pass as object to match API
