...
const BlogCard = ({ blogData, className, style }: { blogData: BlogDataType; className?: string; style?: object }) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col p-4 md:items-center">
                ...
                <h3 className="font-secondary mb-4 text-sm md:text-center lg:text-lg">{blogData.title}</h3>
