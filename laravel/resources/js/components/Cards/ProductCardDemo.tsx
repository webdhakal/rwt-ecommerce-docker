...
const DEMO_DATA = {
    ...
    price: 1024.99,
    discount: 35,
    description: 'Discover the perfect blend of innovation and design in this cutting-edge device that redefines your technological experience.',
    rating: 3.5,
    freeShipping: true,
};
const ProductCardDemo = () => {
    ...
    return (
        <Link href="#" className="flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 p-4">
            <div className="relative w-full max-w-sm transform overflow-hidden rounded-2xl bg-white shadow-2xl transition-all duration-200 hover:scale-105">
                <div className="relative">
                    ...
                    <div className="absolute top-4 right-4 flex flex-col gap-2">
                        ...
                        <Link href="/" className="rounded-full bg-white/50 p-2 text-gray-600 transition-all duration-300 hover:bg-white/70">
