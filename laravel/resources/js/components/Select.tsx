            ...
            <div className={cn('relative', className)}>
                ...
                <div className="relative">
                    <button
                        ...
                        type="button"
                        className={cn(
                            'text-text-primary flex h-10 w-full items-center justify-between rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50',
                    ...
                    {/* Dropdown */}
                    {isOpen && (
                        <div className="text-text-primary absolute z-50 mt-1 w-full rounded-md border border-border bg-background shadow-md">
                            {searchable && (
                            ...
                            <div className="max-h-80 space-y-1 overflow-auto py-1">
                                {filteredOptions?.length === 0 ? (
                                    ...
                                    filteredOptions?.map((option) => (
                                        <div
                                            key={option?.value}
                                            className={cn(
                                                'relative flex cursor-pointer items-center rounded-sm px-3 py-2 text-sm outline-none select-none hover:bg-accent hover:text-accent-foreground',
