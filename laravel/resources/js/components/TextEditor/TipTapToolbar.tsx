...
const TipTapToolbar = ({ editor, content, setContent, onAdd, isHtmlView, toggleHtmlView }: TipTapToolbarProps) => {
    ...
    const addTable = () => {
        editor.chain().focus().insertTable({ rows: tableDetails.rows, cols: tableDetails.columns, withHeaderRow: true }).run();
    };
    ...
    return (
        <div className="flex flex-col gap-4 border border-input px-4 py-3">
            <div className="flex w-full flex-wrap items-center justify-start gap-5">
                        ...
                        <div className="flex flex-col gap-2 p-2">
                            {Array.from({ length: 6 }, (_, i: number) => (
                                <Button
                                    key={i}
                                    variant="ghost"
                                    className={cn('justify-start', editor.isActive('heading', { level: i + 1 }) && activeStyling)}
                                    onClick={(e) => {
                                        e.preventDefault();
                ...
                <Popover>
                    <PopoverTrigger asChild>
                        <Button variant="outline" size="icon" toolTip="Image">
                            <imgDown className="h-4 w-4" />
                        </Button>
                    </PopoverTrigger>
                    <PopoverContent className="w-80">
                        <div className="grid gap-4">
                            <div className="space-y-2">
                                <h4 className="leading-none font-medium">Image Details</h4>
                                <p className="text-sm text-muted-foreground">Set the URL, ALT text, and dimensions for your image.</p>
                            </div>
                            <div className="grid gap-2">
                                ...
                                <div className="grid grid-cols-3 items-center gap-4">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setImageDetails((prev) => ({ ...prev, width: e.target.value }))}
                                        className="col-span-2"
                                        placeholder="e.g. 400"
                                    />
                                </div>
                                <div className="grid grid-cols-3 items-center gap-4">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setImageDetails((prev) => ({ ...prev, height: e.target.value }))}
                                        className="col-span-2"
                                        placeholder="e.g. 300"
                                    />
                                </div>
                ...
                {/* Toggle HTML Button */}
                <Button variant="outline" onClick={toggleHtmlView} toolTip="Toggle HTML" className={cn(isHtmlView && activeStyling)}>
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                        <div className="flex flex-col items-start gap-2 p-2">
                            <Button
                                variant="ghost"
                                className={cn('w-full justify-start', editor.isActive('bulletList') && activeStyling)}
                            ...
                            <Button
                                variant="ghost"
                                className={cn('w-full justify-start', editor.isActive('orderedList') && activeStyling)}
                            ...
                            <Popover>
                                <PopoverTrigger asChild>
                                    <Button variant="ghost" className={cn('w-full justify-start', editor.isActive('table') && activeStyling)}>
                                ...
                                <PopoverContent className="w-80" align="center">
                                    <div className="grid gap-4">
                                        <div className="space-y-2">
                                            <h4 className="leading-none font-medium">Table Details</h4>
                                        ...
                                        <div className="grid gap-2">
                                            <div className="grid grid-cols-3 items-center gap-4">
                                                ...
                                                <Input
                                                    ...
                                                    onChange={(e) => setTableDetails((prev) => ({ ...prev, rows: Number(e.target.value) }))}
                                                    className="col-span-2"
                                                    placeholder="e.g. 3"
                                                />
                                            </div>
                            ...
                            <Dialog>
                                <DialogTrigger className="w-full">
                                    <Button variant="ghost" className={cn('w-full justify-start', editor.isActive('link') && activeStyling)}>
                                ...
                                <DialogContent>
                                    ...
                                    <Input onChange={(e) => setUrlDetails(e.target.value)} placeholder="https://example.com" />
                            ...
                            <Dialog>
                                ...
                                <DialogContent>
                                    <DialogHeader>
                                        ...
                                        <DialogDescription>Enter the number of columns you would like to insert.</DialogDescription>
                                    </DialogHeader>
                                    <Input
                                        type="number"
