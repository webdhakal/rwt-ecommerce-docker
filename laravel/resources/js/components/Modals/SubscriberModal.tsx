        ...
        <div className="bg-opacity-50 fixed inset-0 z-50 flex items-center justify-center bg-black">
          ...
          <div className="flex items-center justify-center gap-2 p-2  font-extrabold text-success">
            ...
            <p className="text-center  font-bold">{flashMessage}</p>
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-[120px_auto] place-items-center gap-2">
                    <AspectRatio ratio={1}>
                        <img src={randomImage()} alt="Subscriber Image" className="h-full w-full rounded-md object-cover select-none" />
                    </AspectRatio>
                    <InputWithLabel
                        id="email"
                        ...
                        renderAfterComponent={
                            <Button size="icon" disabled={processing} variant="secondary" className="rounded-l-none">
                                <Send className="" />
                            </Button>
                        }
                        error={errors.email}
