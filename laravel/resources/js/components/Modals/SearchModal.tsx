...
const SearchModal = () => {
    ...
    return (
        <div className="relative w-full lg:hidden">
            ...
            {searchModalOpen && (
                <div className="bg-opacity-50 fixed inset-0 z-20 items-center justify-center bg-black">
                    <div className="absolute top-28 left-1/2 w-[95%] -translate-x-1/2 rounded-sm bg-white p-4 px-2 shadow-lg dark:bg-black">
