    ...
    return (
        <div className="flex-center w-full">
            <div className="flex-center relative w-full gap-2 md:w-2/3">
                <InputFieldBoxedButton placeholder="What are you looking for today?" callback={setProductSearching} />
                {productSearching && (
                    <div className="absolute top-12 left-0 z-1 h-fit w-full border bg-white p-2">
                        <TagsSection />
                    </div>
                )}
