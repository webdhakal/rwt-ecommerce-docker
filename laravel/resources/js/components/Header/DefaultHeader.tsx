...
export default function DefaultHeader() {
  ...
  return (
    <header
      ref={headerRef}
      className={`fixed left-0 right-0 top-0 z-50 border-b bg-white shadow-sm transition-transform duration-300 ease-in-out ${isVisible ? 'translate-y-0' : '-translate-y-full'
        }`}
