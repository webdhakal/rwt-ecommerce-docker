...
import { Facebook, GitCompare, Heart, Instagram, MapPin, Menu, Search, ShoppingCart, Twitter, User } from 'lucide-react';
...
export default function DefaultHeader() {
    ...
    return (
        <header
            ref={headerRef}
            className={`fixed top-0 right-0 left-0 z-50 border-b bg-white shadow-sm transition-transform duration-300 ease-in-out ${
            ...
            <div className="bg-white px-4 py-4">
                <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
                    ...
                    <div className="mx-8 hidden max-w-2xl flex-1 md:flex">
                        <div className="relative w-full">
                            <Input
                                ...
                                className="w-full rounded-lg border-2 border-slate-200 py-3 pr-12 pl-4 focus:border-primary"
                            />
                            <Button size="sm" className="hover:bg-primarydark absolute top-1 right-1 bottom-1 bg-primary px-4">
                    ...
                    <div className="flex items-center gap-2 md:gap-4">
                        ...
                        <Button variant="ghost" size="sm" className="relative hidden sm:flex" href={route('compare')}>
                        ...
                        {auth.user ? (
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <Button size="sm" className="bg-primary px-2 text-xs hover:bg-emerald-700 md:px-4 md:text-sm">
                                    Sign Up
                                </Button>
                            </div>
                        )}
                        ...
                        <Sheet>
                            ...
                            <SheetContent side="right" className="min-h-screen w-80 overflow-scroll">
