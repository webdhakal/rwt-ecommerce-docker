...
const PaginationLink: FC<PaginationLinkProps> = ({ href, srText, icon: Icon, hiddenOnMd }) => (
    <Link
        ...
        preserveState
        href={href || '#'}
        className={`inline-flex h-8 w-8 items-center justify-center rounded-md border border-gray-200 bg-background p-0 text-sm font-medium whitespace-nowrap shadow-sm hover:bg-gray-50 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 ${
