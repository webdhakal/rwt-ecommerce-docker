...
const RowsPerPageSelect: FC<RowsPerPageSelectProps> = ({ limit, setLimit, setParams, params, setTimeDebounce }) => (
    <Select
        value={limit}
        onValueChange={(value) => {
            setLimit(value);
    ...
    >
        <SelectTrigger className="mt-2 mr-2 h-10 w-[70px] border-gray-300 focus:ring-0 focus:ring-offset-0 focus:outline-none">
...
const TableToolbar: FC<TableToolbarProps> = ({ placeholder, params, setParams, setTimeDebounce, setContent, setAction, search }) => {
