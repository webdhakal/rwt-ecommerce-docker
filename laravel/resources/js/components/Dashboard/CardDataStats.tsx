...
const CardDataStats: React.FC<CardDataStatsProps> = ({ title, total, rate, levelUp, levelDown, children }) => {
    return (
        <div className="border-stroke shadow-default dark:border-strokedark dark:bg-boxdark rounded-sm border bg-white px-7.5 py-6">
            <div className="bg-meta-2 dark:bg-meta-4 flex h-11.5 w-11.5 items-center justify-center rounded-full">{children}</div>
