...
const ImageBannerSlider = () => {
    ...
    return (
        <AnimatedSection>
            <div className={cn('embla relative container my-4 w-full overflow-hidden')} onMouseEnter={stopAutoPlay} onMouseLeave={startAutoPlay}>
                <div className="embla__viewport shadow-5 overflow-hidden" ref={emblaRef}>
                    ...
                    <div className="flex space-x-2">
                        {scrollSnaps.map((_, index) => (
                            <Button
                                ...
                                className={cn('h-3 w-3 rounded-full p-0', selectedIndex === index ? 'bg-primary' : 'bg-slate-300')}
                            >
