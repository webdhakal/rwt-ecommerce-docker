...
import { DiAndroid, DiAngularSimple, DiAppcelerator, DiAppstore, DiAptana, DiAsterisk, DiAtlassian, DiAtom, DiAws, DiBackbone } from 'react-icons/di';
...
const InfiniteSlider = () => {
    ...
    return (
        <div className="container my-12">
            ...
            >
                {[...Array(2)].map((_, i) => (
                    <motion.div key={`infinite-slider-${i}`} className="flex flex-shrink-0" animate={controls}>
                        <SliderContent />
                    </motion.div>
                ))}
            </div>
