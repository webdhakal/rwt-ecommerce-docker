...
const CodeEditorMonaco = ({ content, height, id, viewing, onEdit, onCreate, setState }: Partial<CodeEditorMonacoProps>) => {
    ...
    return (
        <div className="mt-2 rounded-md border border-black p-2">
            <div className="flex-between mb-4">
                {viewing ? (
                    <h1 className="text-sm font-bold whitespace-nowrap">{viewing}'s Content:</h1>
                ) : (
                    <h1 className="text-sm font-bold whitespace-nowrap">JSON Content:</h1>
                )}
