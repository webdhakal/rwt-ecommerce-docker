        ...
        /> */}
          ...
          /> */}
            ...
            <InputField
              ...
              name="second_name"
            /> */}
                        <Input className="h-8 w-full text-xs lg:w-[250px]" name="first_name" placeholder="First Name" />
                        <Input className="h-8 w-full text-xs lg:w-[250px]" name="last_name" placeholder="Last Name" />
                    </div>
                </div>
                <div className="mobile:flex-col mobile:gap-1 flex gap-4">
                    {/* <InputField
          ...
          /> */}
            ...
            <div>
                ...
                <textarea name="order_notes" id="" className="mt-2 h-24 w-full resize-none rounded-md border border-slate-500"></textarea>
            </div>
        </>
    );
};
