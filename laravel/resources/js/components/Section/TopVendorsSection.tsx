    ...
    return (
        <div className="my-4 mb-12 bg-white">
            <div className="container">
                <DefaultSectionTitle title="Top Vendors" subtitle="Our top partners at the platform" showButton={false} />
                            ...
                            {topVendorsMock.map((vendor) => (
                                <TabsTrigger
                                    ...
                                    className={cn(
                                        ...
                                        vendor.id === selectedTab ? 'ring-success ring-1' : '',
                                    )}
                                >
                                    <div>
                                        <p
                                    ...
                                    <span className="text-sm font-semibold text-gray-700">Sales - {vendor.sales}</span>
                                </TabsTrigger>
                            ))}
                        </TabsList>
                    </Tabs>
