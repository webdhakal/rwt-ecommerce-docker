...
const MobileDealsSection = () => {
    ...
    return (
        <div ref={callbackRef} className={cn('bg-black opacity-0', isVisible && 'animate-slideInFromBottom')}>
            <div className="container mt-8 mb-4 md:hidden">
            ...
            <section className="container my-6 flex py-4 md:py-8">
                <div className="hidden w-[300px] flex-col justify-between pr-6 text-white md:flex">
                    <div>
                        ...
                        <span className="mt-8 flex items-center gap-2 text-2xl font-bold text-yellow-500 uppercase">
                            <Tags />
                            <span>drops</span>
                        </span>
                        <p className="mt-2">Snag limited products release and additional savings - only in the app.</p>
                    </div>
                    <Button className="mt-4 w-full">Get the app</Button>
                </div>
                <div className="w-full text-white">
                    <div className="embla h-full overflow-hidden" ref={emblaRef} onMouseEnter={stopAutoPlay} onMouseLeave={startAutoPlay}>
