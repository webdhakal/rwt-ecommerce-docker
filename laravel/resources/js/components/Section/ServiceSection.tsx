...
const ServiceSection = () => {
    return (
        <AnimatedSection className={cn('hidden bg-gradient-to-r from-primary to-emerald-400 py-6 md:block')}>
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    {ServiceBlockData.map((item, index) => (
                        ...
                        >
                            ...
                            <h3 className="mb-1.5 text-base font-semibold text-gray-800 lg:text-lg">{item.title}</h3>
