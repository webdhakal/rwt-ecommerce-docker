...
export default function HeroSection() {
    return (
        <AnimatedSection>
            <section className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-background to-accent/5 lg:mt-26">
                {/* Background Pattern */}
                ...
                <div className="relative container mx-auto px-4 pt-20 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-16 text-center">
                        ...
                        <h1 className="mb-6 space-y-2 text-2xl leading-tight font-bold text-foreground sm:text-3xl lg:text-5xl">
                            Discover Premium
                        ...
                        <p className="mx-auto mb-8 max-w-2xl text-sm leading-relaxed text-muted-foreground">
                            Curated collection of high-quality products designed to enhance your lifestyle. From tech to fashion, find everything you
                            need in one place.
                        </p>
                    ...
                    <div className="hidden grid-cols-1 gap-6 sm:grid-cols-2 md:grid lg:grid-cols-4 lg:gap-8">
                        {featuredProducts.map((product) => (
                            <Card
                                key={product.id}
                                className="group cursor-pointer border-0 bg-card/80 shadow-lg backdrop-blur-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl"
                            >
                                <CardContent className="p-0">
                                    ...
                                    <div className="relative overflow-hidden rounded-t-lg">
                                        ...
                                        <div className="absolute top-3 left-3">
                                            <Badge
                                                variant={
                                                    product.badge === 'New' ? 'default' : product.badge === 'Best Seller' ? 'secondary' : 'outline'
                                                }
