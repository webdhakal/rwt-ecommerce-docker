...
const InvoicePDF = () => {
    const { brandName, topRightLogo, invoiceNumber, invoiceDate, dueDate, from, to, items, summary } = invoiceData;
        ...
        <div className="container mx-auto my-12 px-4">
            <div id="invoice" className="border border-gray-300 bg-white text-sm text-gray-700">
                <header className="relative bg-primary py-3 text-center text-white">
                    ...
                    {topRightLogo && <img src={topRightLogo} alt="Top Right Logo" className="absolute top-2 right-4 h-10 object-contain" />}
                </header>
                ...
                <div className="flex flex-col border-b border-gray-300 sm:flex-row">
                    <div className="w-full border-r border-gray-300 p-4 sm:w-1/2">
                        <h2 className="mb-2 font-bold text-primary uppercase">Bill To</h2>
                        <p className="font-semibold">
                    ...
                    <div className="w-full p-4 sm:w-1/2">
                        <h2 className="mb-2 font-bold text-primary uppercase">Shipping To</h2>
                        <p className="font-semibold">
                            Name: <span className="font-normal">{to.name}</span>
                        </p>
                        <p className="font-semibold">
                ...
                <div className="flex flex-col sm:flex-row">
                    <div className="w-full border-r border-gray-300 p-4 sm:w-2/3">
                        <p className="mb-2 font-semibold">
                            Amount in words:{' '}
                            <span className="font-normal italic">{numberToWords(Number(summary.grandTotal.toString().split('.')[0]))} - Only</span>
                        </p>
            ...
            <footer className="pt-4 text-center text-sm text-gray-600">
                <p>
                    ...
                    <a href="https://rwt.nextwebstudio.net" className="font-medium text-blue-600 hover:underline">
                        https://rwt.nextwebstudio.net
                    </a>
                </p>
                <p className="mt-2">Have a great day!</p>
                <p className="mt-4 text-xs text-gray-400">** This is a computer-generated copy. No signatures required. **</p>
            </footer>
